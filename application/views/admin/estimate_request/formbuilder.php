                    ...
                    <div class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane" id="tab_form_integration">
                            ...
                            <textarea class="form-control"
                                rows="2"><iframe width="600" height="850" src="<?= site_url('forms/quote/' . $form->form_key); ?>" frameborder="0" sandbox="allow-top-navigation allow-forms allow-scripts allow-same-origin allow-popups" allowfullscreen></iframe></textarea>
                            <h4 class="tw-my-5 bold">Share direct link</h4>
                            <p>
                                <span class="label label-default">
                                    <a href="<?= site_url('forms/quote/' . $form->form_key) . '?styled=1'; ?>"
                                        target="_blank">
                                ...
                                <br />
                                <span class="label label-default">
                                    <a href="<?= site_url('forms/quote/' . $form->form_key) . '?styled=1&with_logo=1'; ?>"
                                        target="_blank">
                            ...
                            <div
                                ...
                                <div class="tab-content">
                                    <div role="tabpanel" class="tab-pane active" id="tab_config_general">
                                        ...
                                        <div class="form-group select-placeholder">
                                            <label for="language" class="control-label">
                                                <i class="fa-regular fa-circle-question" data-toggle="tooltip"
                                                    data-title="<?= _l('form_lang_validation_help'); ?>"></i>
                                        ...
                                        <?= render_estimate_request_status_select(
                                            $statuses,
...
?>
                                        <?= render_select('responsible', $members, ['staffid', ['firstname', 'lastname']], 'estimate_request_assignee', $selected); ?>
                                    ...
                                    <div role="tabpanel" class="tab-pane" id="tab_config_submission">
                                        <label for=""
                                            class="control-label bold"><?= _l('form_submit_success_action'); ?>?</label>
                                    ...
                                    <div role="tabpanel" class="tab-pane" id="tab_config_notifications">
                                        ...
                                        <div class="checkbox">
                                            <input type="checkbox" name="notify_request_submitted"
                                                ...
                                                <?= isset($form) && $form->notify_request_submitted == 1 || ! isset($form) ? 'checked' : ''; ?>>
                                            <label for="notify_request_submitted">
                                                <?= _l('estimate_request_notify_when_submitted'); ?>
                                            </label>
                                        </div>
                                        <div
                                            class="select-notification-settings tw-mt-6<?= isset($form) && $form->notify_request_submitted == '0' ? ' hide' : ''; ?>">
...
?>
                                                <?= render_select('notify_ids_staff[]', $members, ['staffid', ['firstname', 'lastname']], 'estimate_request_notify_staff', $selected, ['multiple' => true]); ?>
                                            </div>
                                            <div id="role_notify"
...
?>
                                                <?= render_select('notify_ids_roles[]', $roles, ['roleid', ['name']], 'estimate_request_notify_roles', $selected, ['multiple' => true]); ?>
                                            </div>
                                        </div>
                                    </div>
            ...
            responsible: {
                required: {
                    depends: function(element) {
                        var isRequired = ($('input[name="notify_type"]:checked').val() ==
                                'assigned') ?
                            true : false;
                        if (isRequired) {
