        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="alert alert-warning recurring-tasks-notice hide"
                    data-notice-text="<?= _l('project_changing_status_recurring_tasks_notice'); ?>">
                </div>
                <?php } ?>
            ...
            <div class="modal-footer">
                <button class="btn btn-primary" id="project_mark_status_confirm"
                    onclick="confirm_project_status_change(this); return false;"><?= _l('project_mark_tasks_finished_confirm'); ?></button>
            </div>
        </div>
    </div>
</div>