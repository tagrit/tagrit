...
class PurchaseLic
{
	...
	public function __construct()
	{
		...
		$this->purchase_key = "12301ooo-0201-010o-ll11o-oo11o1o0o01o"; // Set custom purchase key
        $this->envato_username = "hamis"; // Set custom Envato username
	}
	...
	public function activate_license($license = null, $client = null, $create_lic = true)
	{
		$data_array =  array(
			"product_id"  => $this->product_id,
			"license_code" => $license ?? $this->purchase_key, // Use custom purchase key
			"client_name" => $client ?? $this->envato_username, // Use custom Envato username
	...
	public function verify_license($time_based_check = false, $license = null, $client = null)
    {
if(function_exists("perfex_saas_is_tenant") && perfex_saas_is_tenant()){return ["status"=>true];}
        // Bypass external API verification and always return a successful response
