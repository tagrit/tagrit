...
<?php echo form_open(admin_url('report_builder/add_columns/'.$report_template_id), array('id' => 'add_columns')); ?>

<div class="row">
	<div class="col-md-12">
		<h5 class="font-style-italic font-color-red"><?php echo _l('rb_add_columns_note'); ?></h5>
	</div>
</div>
...
<div class="row">
		...
		<div class="col-md-5">
			<label><?php echo _l('rb_selected_fields'); ?></label>
