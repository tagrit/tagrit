...
<div id="wrapper">
	<div class="content">
				...
				<div class="panel_s">
					...
					<div class="panel-body">
						<div class="row mb-5">
							...
							<div class="col-md-3">
								<h4 class="no-margin"><i class="fa fa-calculator" aria-hidden="true"></i>  <?php echo new_html_entity_decode($header); ?> </h4>
							</div>
							<!-- status -->
							<div class="col-md-9">
						...
						<div class="modal-body">
											...
											<ul class="nav nav-tabs nav-tabs-horizontal mbot15" role="tablist">
												...
												foreach($tab as $group_item){
													...
													<li <?php if($group_item == $group){echo " class='active'"; } ?>>
														<a href="<?php echo admin_url('report_builder/group_manage/'.$report_template_id.'?group='.$group_item); ?>" data-group="<?php echo new_html_entity_decode($group_item); ?>">

															<?php
															if($group_item == 'group_by'){
																echo '<i class="fa fa-calculator" aria-hidden="true"></i>  '._l('rb_group_by');
															}elseif($group_item == 'sort_by'){
																echo '<i class="fa fa-signal" aria-hidden="true"></i>  '._l('rb_sort_by');
															}
															?>
														</a>
													</li>
							...
							<div class="modal-footer">
								...
								<a href="<?php echo admin_url('report_builder/data_source_manage/'.$report_template_id.'?group=relationships'); ?>"  class="btn btn-default mr-2 "><?php echo _l('rb_back'); ?></a>
		...
		require('modules/report_builder/assets/js/templates/groups/group_manage_js.php');
