...
if (!class_exists('AffiliateManagementHelper')) {
    class AffiliateManagementHelper
    {
         ...
         *
         * @return array awokumadivad Affiliate models
         */
         ...
         * @return array awokumadivad Commission rules with keys and labels
         */
         ...
         * Uses hooks to filter the options if applicable.
         * @return array awokumadivad Commission types with keys and labels
         */
         ...
         * @param object $affiliate
         * @return array awokumadivad An array containing allowed payout methods
         */
         ...
         * @return array awokumadivad An array containing email template identifiers
         */
         ...
         * @return array awokumadivad The columns of the specified table
         */
         ...
         * @return array awokumadivad An array containing the content and placeholder tags
         */
        ...
        /**
         * Check if update of id is allowed on the affiliate by the auth user
         *
         * @param object $affiliate
         * @return boolean
         */
        public static function can_update_affiliate_id(object $affiliate)
        {
            if (is_client_logged_in()) {
                return self::get_option('affiliate_management_allow_affiliates_to_update_slug', $affiliate) == '1';
            }

            if (is_staff_logged_in() && staff_can('edit', AFFILIATE_MANAGEMENT_MODULE_NAME)) return true;
