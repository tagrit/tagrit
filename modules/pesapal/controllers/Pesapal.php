...
class Pesapal extends App_Controller
{
    ...
    <div class="container">
        ...
        <h4><?php echo _l('payment_total', app_format_money($data['total'], 'KES')); ?></h4>
        <hr/>
    ...
    <?php } else { ?>
        <div class="alert alert-warning">Sorry, an error occurred while processing your request. We are working to fix
