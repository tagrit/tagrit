...
<div id="wrapper">
    <div class="content">
        <div class="content-blur-wrapper" id="contentWrapper">
            <div class="panel_s">
                <div class="panel-body">
                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <select class="form-control selectpicker no-border-right"
                                                            data-live-search="true" name="event_id" id="events"
                                                            required>
                                                        <?php if (!empty($events)): ?>
                        ...
                        <div class="col-md-12 mtop15">
                            <button id="submitRegistrationBtn" type="submit" class="btn btn-primary btn-block">Submit
                                Registration
                            </button>
                        </div>
                        <?php echo form_close(); ?>
...
<script>
    $(document).ready(function () {
        ...
        document.getElementById('register-for-event-form').addEventListener('submit', function (event) {
            document.getElementById('circleLoader').style.display = 'flex'; // block → flex
